  ...
  return (
    <div className="bg-[#FBF3ED] py-12">
      <div className="flex flex-col max-w-6xl items-center justify-center ">
        ...
        <p className="text-gray-600 px-2 sm:px-0 text-center">
          At EverHope, we deliver an unparalled recovery experience by
        </p>
      </div>

      <ResponsiveCarousel data={carouselData} autoSlideInterval={3000} />
    </div>
  );
}
  ...
  return (
    <section className="bg-[#FBF3ED] py-10 px-4 relative">
      <div className="relative z-10">
        ...
        {/* Auto-slide pause indicator (Large Screen)
        {isLargeScreen && (
...
const CarouselCard: React.FC<CarouselCardProps> = ({
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-lg w-[300px] hover:shadow-xl transition-shadow duration-200 ${className}`}
    >
      {/* Image Section */}
